...
@Entity
@Table(name = "projectmanage_userinfor", schema = "bccm", catalog = "")
public class ProjectmanageUserinforEntity {
    private String guid;
    ...
    public boolean equals(Object o) {
        ...
        ProjectmanageUserinforEntity that = (ProjectmanageUserinforEntity) o;
