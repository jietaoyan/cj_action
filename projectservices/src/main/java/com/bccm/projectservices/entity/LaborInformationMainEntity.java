...
@Entity
@Table(name = "labor_information_main", schema = "bccm")
public class LaborInformationMainEntity {
    private String guid;
    ...
    public boolean equals(Object o) {
        ...
        LaborInformationMainEntity that = (LaborInformationMainEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(guid, sysid, state, remark, content, companypath, updatedt, updatebyusername, updatebyuserfullname, inputerdeptid, inputerdeptpathid, inputerdeptname, companyname, inputername, inputerfullname, type, name, prjno, prjname, sysprjid, inputdate, tel, column1, column2, column3, column4, column5, deleteflag);
    }
}
